...
- A `krynox` validation rule, a service provider with auto-discovery, and a Blade
  directive for the widget embed.

[0.1.0]: https://github.com/krynox-security/plugin-laravel/releases/tag/v0.1.0
